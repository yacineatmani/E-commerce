...
const CarouselProduitsCultery = () => {
  ...
  useEffect(() => {
    fetch('/src/data.json')
      ...
      .then(data => {
        const culteryProducts = data.products.filter(product => product.category === 'cultery');
        setProducts(culteryProducts);
      });
  }, []);
...
export default CarouselProduitsCultery;