...
const CarouselProduitsMistery = () => {
  ...
  useEffect(() => {
    fetch('/src/data.json')
      ...
      .then(data => {
        const misteryProducts = data.products.filter(product => product.category === 'mistery');
        setProducts(misteryProducts);
      });
  }, []);
...
export default CarouselProduitsMistery;